...
check_tcp "Glance" "$MEDIA_IP" 8081
printf '\n'
...
check_http "Hindsight API health" "http://${HINDSIGHT_IP}:8888/health" "healthy|connected|status"
check_http "Hindsight control plane" "http://${HINDSIGHT_IP}:9999" "html|hindsight|window"
