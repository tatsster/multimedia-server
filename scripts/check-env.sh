...
ENV_EXAMPLES=(
  ...
  "hindsight/config/hindsight.env.example"
)
...
check_env_from_example "server-arr/.env.example" "server-arr/.env"
check_env_from_example "glance/.env.example" "glance/.env"
check_env_from_example "omniroute/config/omniroute.env.example" "omniroute/config/omniroute.env"
check_env_from_example "hindsight/config/hindsight.env.example" "hindsight/config/hindsight.env"
