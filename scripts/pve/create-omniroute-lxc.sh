...
#   /usr/bin/omniroute -> /usr/lib/node_modules/omniroute/bin/omniroute.mjs
pct_bash "$CTID" "npm install -g omniroute"

pct_bash "$CTID" "cat >/root/.omniroute/omniroute.env <<ENV
PORT=20128
...
ENV
chmod 600 /root/.omniroute/omniroute.env"
...
EnvironmentFile=-/root/.omniroute/omniroute.env
