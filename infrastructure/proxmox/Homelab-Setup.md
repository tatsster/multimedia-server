...
- Main rebuild runbook: [`Fresh-Homelab-Rebuild.md`](../../docs/rebuild/Fresh-Homelab-Rebuild.md)
- Canonical CT/IP/mount inventory: [`inventory/lxc-map.md`](../../inventory/lxc-map.md)
- Verification checklist: [`VERIFY.md`](../../docs/verify.md)
...
![Harddisk setup](../../assets/disk_setup.png)
...
![Shared mount example](../../assets/shared_mnt.png)
