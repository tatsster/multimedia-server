...
| Hermes | Manual script in this repo | Custom Hermes config, gateway, OmniRoute/OpenViking integration |
...
Do **not** run the Cloudflared community script as a second LXC for the normal rebuild. See `../../infrastructure/proxy/Access-Setup.md` for the combined Caddy + Tunnel + MCP setup.
