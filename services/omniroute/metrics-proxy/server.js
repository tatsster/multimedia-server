...
const PORT = Number(process.env.PORT || process.env.OMNIROUTE_METRICS_PROXY_PORT || 20129);
const HOST = process.env.HOST || process.env.OMNIROUTE_METRICS_PROXY_HOST || '0.0.0.0';
...
const DASHBOARD_TOKEN = process.env.OMNIROUTE_DASHBOARD_TOKEN || '';
const CACHE_SECONDS = Number(process.env.CACHE_SECONDS || process.env.OMNIROUTE_METRICS_PROXY_CACHE_SECONDS || 60);
const TIMEOUT_MS = Number(process.env.TIMEOUT_MS || process.env.OMNIROUTE_METRICS_PROXY_TIMEOUT_MS || 10000);
